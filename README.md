...
- 2. На гугл-диске лежат следующие файлы: 
  ...
  - lm.binary - языковая модель для обучения скорера,
  - vocab-5000000.txt - список часто встречающихся слов, необходимый для обучения скорера,
  - kenlm.scorer - скорер, необходимый для запуска модели и коректного распознавания текста,
